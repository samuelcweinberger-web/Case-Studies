    ...
    <section class="hero hero-page hero-cinema">
      <div class="hero-media" aria-hidden="true">
        <div class="hero-slides" data-hero-slides>
          ...
          <img class="hero-slide" src="media/hero/slide-whiteboard.jpg" alt="" loading="lazy" decoding="async" />
          <img class="hero-slide hero-slide--face" src="media/hero/slide-sam-folder.jpg" alt="" loading="lazy" decoding="async" />
          <img class="hero-slide" src="media/hero/slide-sketching.jpg" alt="" loading="lazy" decoding="async" />
          <img class="hero-slide" src="media/hero/slide-sam-review.jpg" alt="" loading="lazy" decoding="async" />
          ...
          <img class="hero-slide" src="media/hero/slide-present.jpg" alt="" loading="lazy" decoding="async" />
          <img class="hero-slide" src="media/hero/slide-sam-pen.jpg" alt="" loading="lazy" decoding="async" />
          <img class="hero-slide" src="media/hero/slide-storyboards.jpg" alt="" loading="lazy" decoding="async" />
