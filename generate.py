...
ABOUT_COPY = """
          ...
          <p>A note on the term “UX Engineer”: I’m not a backend engineer. I use it to describe a modern hybrid—I conduct research, then engineer the operations needed to build a strong foundation for user experience work and connect it with analytics, design, and product management. Drawing on skills from design, data science, product management, and research operations, I deliver insights that drive overall product development and strategy—and keep every research effort tied directly to business objectives.</p>
