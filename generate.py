...
ABOUT_COPY = """
          ...
          <p>As a UX Engineer, I represent a modern hybrid: I conduct research, then engineer the operations needed to build a strong foundation for user experience work—connecting it with analytics, design, and product management. I employ skills from design, data science and analytics, product management, and research operations to deliver insights that drive overall product development and strategy. Leveraging skillsets from all of those fields is what lets me tie every research effort directly to business objectives.</p>
